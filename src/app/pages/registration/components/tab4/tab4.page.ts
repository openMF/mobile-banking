  ...
  constructor(
    ...
    this.registerForm = formBuilder.group({
      ...
      rfc: ["", Validators.compose([
        Validators.required,
        CustomValidators.ValidateRfc
      ])],
      dateOfBirth: ["", Validators.required],
      dateFormat: "yyyy-MM-dd",
      locale: "es",
      authenticationMode: "email",
      numberIne: ["", Validators.compose([
        Validators.required,
        CustomValidators.ValidateNumberIne
      ])],
      yearIne: ["", Validators.compose([
        Validators.required,
        CustomValidators.ValidateYear
      ])],
      issueNumber:["", Validators.compose([
        Validators.required,
        CustomValidators.ValidateissueNumber
      ])],
      electorKey:["", Validators.compose([
        Validators.required,
        CustomValidators.ValidateKeyIne
      ])],
    });
  ...
  getActivationCode(): Promise<any> {
    ...
    return this.storage.get('registration').then(value => {
      ...
      this.completeForm = {
        ...
        entityBirth: value.entityBirth.trim(),
        shaded: true,
        channel: "Movil",
        username: value.mobileNumber.trim()
